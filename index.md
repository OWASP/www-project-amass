...
layout: col-sidebar
title: OWASP Amass
tags: owasp amass dns asm osint recon asset-discovery network-security builders
project: true
level: 4
type: tool
pitch: An open source framework that helps information security professionals perform network mapping of attack surfaces and external asset discovery using open source intelligence gathering and reconnaissance techniques!
